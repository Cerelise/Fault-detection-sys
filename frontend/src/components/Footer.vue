<template>
	<footer class="mt-1 mx-6 pt-10 pb-15">
		<div
			class="container border-t border-slate-400/20 flex items-center justify-between gap-10"
		>
			<p
				class="mt-2 flex items-center gap-1 text-[0.8125rem] leading-6 text-white"
			>
				<svg class="w-3" height="18" aria-hidden="true">
					<path
						fill-rule="evenodd"
						clip-rule="evenodd"
					...
					></path></svg
				><span
					>By the makers of <a href="#" class="font-bold">tailwindcss</a></span
				>
			</p>

			<a
				class="mt-2 rounded-lg text-white font-semibold transition flex items-center gap-1 text-[0.8125rem] leading-6 py-1 px-1.5 -my-1 -mx-1.5"
				href="#"
			>
				<!-- <svg
					viewBox="0 0 20 20"
					aria-hidden="true"
					class="h-3 w-3 fill-slate-400"
				>
					<path
				...
				<span>To github repository</span></a
			>
		</div>
	</footer>
</template>
